...
clean-Core-2f-Src:
	-$(RM) ./Core/Src/function_calibration.cyclo ./Core/Src/function_calibration.d ./Core/Src/function_calibration.o ./Core/Src/function_calibration.su ./Core/Src/function_refill.cyclo ./Core/Src/function_refill.d ./Core/Src/function_refill.o ./Core/Src/function_refill.su ./Core/Src/funtion_main.cyclo ./Core/Src/funtion_main.d ./Core/Src/funtion_main.o ./Core/Src/funtion_main.su ./Core/Src/gpio.cyclo ./Core/Src/gpio.d ./Core/Src/gpio.o ./Core/Src/gpio.su ./Core/Src/main.cyclo ./Core/Src/main.d ./Core/Src/main.o ./Core/Src/main.su ./Core/Src/manager_file.cyclo ./Core/Src/manager_file.d ./Core/Src/manager_file.o ./Core/Src/manager_file.su ./Core/Src/manager_io.cyclo ./Core/Src/manager_io.d ./Core/Src/manager_io.o ./Core/Src/manager_io.su ./Core/Src/manager_mux.cyclo ./Core/Src/manager_mux.d ./Core/Src/manager_mux.o ./Core/Src/manager_mux.su ./Core/Src/manager_relay.cyclo ./Core/Src/manager_relay.d ./Core/Src/manager_relay.o ./Core/Src/manager_relay.su ./Core/Src/manager_weigt.cyclo ./Core/Src/manager_weigt.d ./Core/Src/manager_weigt.o ./Core/Src/manager_weigt.su ./Core/Src/stm32f4xx_hal_msp.cyclo ./Core/Src/stm32f4xx_hal_msp.d ./Core/Src/stm32f4xx_hal_msp.o ./Core/Src/stm32f4xx_hal_msp.su ./Core/Src/stm32f4xx_it.cyclo ./Core/Src/stm32f4xx_it.d ./Core/Src/stm32f4xx_it.o ./Core/Src/stm32f4xx_it.su ./Core/Src/syscalls.cyclo ./Core/Src/syscalls.d ./Core/Src/syscalls.o ./Core/Src/syscalls.su ./Core/Src/sysmem.cyclo ./Core/Src/sysmem.d ./Core/Src/sysmem.o ./Core/Src/sysmem.su ./Core/Src/system_stm32f4xx.cyclo ./Core/Src/system_stm32f4xx.d ./Core/Src/system_stm32f4xx.o ./Core/Src/system_stm32f4xx.su ./Core/Src/tim.cyclo ./Core/Src/tim.d ./Core/Src/tim.o ./Core/Src/tim.su ./Core/Src/usart.cyclo ./Core/Src/usart.d ./Core/Src/usart.o ./Core/Src/usart.su
